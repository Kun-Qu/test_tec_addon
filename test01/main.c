                                              ...
                                              char **ErrMsg)             /* OUT (only if returning FALSE) */
{
     ...
     * Example:
     *
     * $!ADDONCOMMAND ADDONID='test add on No.1' COMMAND='MYCOMMAND'
     */
...
static void STDCALL StateChangeCallback(StateChange_e StateChange)
{
    ...
    switch (StateChange)
    {
        ...
        case StateChange_NewTopFrame:         /* Deprecated: Replaced by NewActiveFrame and/or FrameOrderChange */
        ...
        case StateChange_NewActiveFrame:      /* A different frame has become the active frame */
        case StateChange_FrameOrderChanged:   /* The frame order on the current page has been changed */
